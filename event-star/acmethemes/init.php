 ...
 */
if ( is_admin() ) {
    require_once event_star_file_directory('acmethemes/at-theme-info/class-at-theme-info.php');
    require_once event_star_file_directory('acmethemes/admin-notice/class-admin-notice-handler.php');
}